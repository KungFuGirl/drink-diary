...
RSpec.describe WinesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested wine as @wine" do
      wine = Wine.create! valid_attributes
      get :show, params: {id: wine.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested wine as @wine" do
      wine = Wine.create! valid_attributes
      get :edit, params: {id: wine.to_param}, session: valid_session
      expect(assigns(:wine)).to eq(wine)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Wine" do
        expect {
          post :create, params: {wine: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved wine as @wine" do
        post :create, params: {wine: invalid_attributes}, session: valid_session
        expect(assigns(:wine)).to be_a_new(Wine)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested wine" do
        wine = Wine.create! valid_attributes
        put :update, params: {id: wine.to_param, wine: new_attributes}, session: valid_session
        wine.reload
      ...
      it "assigns the requested wine as @wine" do
        wine = Wine.create! valid_attributes
        put :update, params: {id: wine.to_param, wine: valid_attributes}, session: valid_session
        expect(assigns(:wine)).to eq(wine)
      end
    ...
    context "with invalid params" do
      it "assigns the wine as @wine" do
        wine = Wine.create! valid_attributes
        put :update, params: {id: wine.to_param, wine: invalid_attributes}, session: valid_session
        expect(assigns(:wine)).to eq(wine)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested wine" do
      wine = Wine.create! valid_attributes
      expect {
        delete :destroy, params: {id: wine.to_param}, session: valid_session
      }.to change(Wine, :count).by(-1)
    end
